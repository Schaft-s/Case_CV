...
![](pictures/mask2.png)
![](pictures/mask3.png)
  - _(итоговые модели сохранялись в формате .pt-.pth и оказались достаточно объёмными, в итоге не хотят загружаться на гитхаб, скину по требованию, если что - почта firsov.sa@phystech.su)_
### Анализ результатов
...
Большое спасибо за внимание, особенно если дочитали до этого момента.
Моё резюме - [тут](https://www.overleaf.com/read/sqdgmpycgvry#f4fed8) и [тут](https://github.com/Schaft-s/cv/tree/main).
Способы связи: почта - firsov.sa20@gmail.com и мессенджер - https://t.me/schaft_192
