...
### Подготовка датасета
  - Первоначально надо собрать данные.
    - Нам они были выданы, поэтому взял их.
  ...
  - Далее нужно разделить их на train, validation, test.
    ...
    - Отобрал 50 почти случайных картинок и отложил их в отдельную папку. 
    - _(итоговый используемый датасет достаточно объёмный и не хочет загружаться на гитхаб, скину по требованию, если что-почта firsov.sa@phystech.su)_
### Разметка в CVAT
